...
plugin, which creates the final files for the site. These CSS and JS files are generated in the `frontend` docker
container.
...
the UI. The RAML HTML is generated in the `frontend` docker container.
