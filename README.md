...
| _lars.log_     | Used to log monthly updates to hardware based on the LARS PPD DB                                                                                                                                                                      | DEBUG     | No                  |
...
Save and exit the `nano` editor. After 60 seconds, re-run the failing use-case and the log level will be changed. Remember to reset the log level back
