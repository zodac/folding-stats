 ...
 */
@Singleton
public class UserStateChangeChecker {
    ...
    public boolean isHardwareStateChange(final Hardware updatedHardware, final Hardware existingHardware) {
        ...
        return !existingMultiplier.equals(updatedMultiplier);
    }
    ...
    public void handleStateChange(final User userWithStateChange) throws ExternalConnectionException {
        ...
        // TODO: Before initial? Relying on cache being valid otherwise
