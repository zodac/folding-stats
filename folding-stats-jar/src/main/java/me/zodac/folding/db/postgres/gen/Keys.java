...
public class Keys {
    ...
    public static final UniqueKey<UserChangesRecord> USER_CHANGES_PKEY = Internal.createUniqueKey(UserChanges.USER_CHANGES, DSL.name("user_changes_pkey"), new TableField[] { UserChanges.USER_CHANGES.CHANGE_ID }, true);
