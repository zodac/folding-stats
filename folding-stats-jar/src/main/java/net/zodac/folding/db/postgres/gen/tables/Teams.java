...
import net.zodac.folding.db.postgres.gen.tables.RetiredUserStats.RetiredUserStatsPath;
...
public class Teams extends TableImpl<TeamsRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.INDEX_TEAM_ID);
    }
    ...
    public List<UniqueKey<TeamsRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.TEAMS_TEAM_NAME_KEY);
    }

    private transient RetiredUserStatsPath _retiredUserStats;

    /**
     * Get the implicit to-many join path to the
     * <code>public.retired_user_stats</code> table
     */
    public RetiredUserStatsPath retiredUserStats() {
        if (_retiredUserStats == null)
            _retiredUserStats = new RetiredUserStatsPath(this, null, Keys.RETIRED_USER_STATS__FK_TEAM_ID.getInverseKey());

        return _retiredUserStats;
    }
    ...
    public UsersPath users() {
        if (_users == null)
            _users = new UsersPath(this, null, Keys.USERS__FK_TEAM_ID.getInverseKey());
