...
usersTableHead.append(usersTableHeaderRow);usersTable.append(usersTableHead);usersTableBody=document.createElement("tbody");a.forEach(function(a,d){usersTableBodyRow=document.createElement("tr");b.forEach(function(c,b){usersTableBodyCell=document.createElement("td");"liveStatsLink"===c?c in a&&(liveStatsLink=document.createElement("a"),liveStatsLink.setAttribute("href",a[c]),liveStatsLink.innerHTML=a[c],usersTableBodyCell.append(liveStatsLink)):c in a&&(usersTableBodyCell.innerHTML=a[c].toLocaleString());
...
!0;break}}else if(parseInt(f.innerHTML)<parseInt(g.innerHTML)){h=!0;break}h?(c[e].parentNode.insertBefore(c[e+1],c[e]),d=!0,l++):0==l&&"asc"==k&&(k="desc",d=!0)}}function updateTimer(){var a=new Date,a=3600-(a.getUTCMinutes()-55)%60*60-a.getUTCSeconds();minutes=Math.floor(a/60)%60;seconds=a%60;document.getElementById("min-part").innerHTML=minutes;document.getElementById("sec-part").innerHTML=String(seconds).padStart(2,"0");setTimeout(updateTimer,1E3-(new Date).getUTCMilliseconds())};