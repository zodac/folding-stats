...
displayName:b,passkey:c,category:d,hardwareId:e,profileLink:f,liveStatsLink:g,isRetired:!1});show("loader");fetch(ROOT_URL+"/users",{method:"POST",headers:{"Content-Type":"application/json",Authorization:sessionGet("Authorization")},body:a}).then(function(a){hide("loader");201!=a.status?(failureToast("User create failed with code: "+a.status),a.json().then(function(a){console.error(JSON.stringify(a,null,2))})):(document.getElementById("user_create_id").value="",document.getElementById("user_create_folding_name").value=
"",document.getElementById("user_create_display_name").value="",document.getElementById("user_create_passkey").value="",document.getElementById("user_create_category").value="",document.getElementById("user_create_hardware_selector").value="",document.getElementById("user_create_profile_link").value="",document.getElementById("user_create_live_stats_link").value="",successToast("User '"+b+"' created"),loadUsers())}).catch(function(a){console.error("Unexpected error creating user: ",a);return!1})}
...
selectedElement.getAttribute("user_display_name");document.getElementById("user_update_passkey").value=selectedElement.getAttribute("user_passkey");document.getElementById("user_update_category").value=selectedElement.getAttribute("user_category");document.getElementById("user_update_hardware_selector").value=selectedElement.getAttribute("user_hardware_id");"undefined"!==profileLink&&(document.getElementById("user_update_profile_link").value=profileLink);"undefined"!==liveStatsLink&&(document.getElementById("user_update_live_stats_link").value=
liveStatsLink);userFields=document.querySelectorAll(".user_update");for(var a=0,b;b=userFields[a];a++)showElement(b);hide("loader")}
...
selectedElement.getAttribute("user_display_name");document.getElementById("user_delete_passkey").value=selectedElement.getAttribute("user_passkey");document.getElementById("user_delete_category").value=selectedElement.getAttribute("user_category");document.getElementById("user_delete_hardware_selector").value=selectedElement.getAttribute("user_hardware_id");"undefined"!==profileLink&&(document.getElementById("user_delete_profile_link").value=profileLink);"undefined"!==liveStatsLink&&(document.getElementById("user_delete_live_stats_link").value=
liveStatsLink);userFields=document.querySelectorAll(".user_delete");for(var a=0,b;b=userFields[a];a++)showElement(b);hide("loader")}function show(a){document.getElementById(a).style.display="block"}function showElement(a){a.style.display="block"}function hide(a){document.getElementById(a).style.display="none"}function hideElement(a){a.style.display="none"}function encode(a,b){return btoa(a+":"+b)}function sortJsonByKey(a){return function(b,c){return b[a]>c[a]?1:b[a]<c[a]?-1:0}}
