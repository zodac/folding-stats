...
function adminLogin(){var a=document.getElementById("inputUserName").value,b=document.getElementById("inputPassword").value,c="Basic "+encode(a,b);console.log("Username: "+a);console.log("Password: "+b);console.log("Encoded: "+c);fetch(ROOT_URL+"/login/admin",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({encodedUserNameAndPassword:c})}).then(function(a){200!=a.status?showToast("toast-login-failure",!0):showToast("toast-login-success",!0)})}
