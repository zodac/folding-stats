...
function printCache(){show("loader");fetch(ROOT_URL+"/debug/caches",{headers:{"Content-Type":"application/json",Authorization:sessionGet("Authorization")}}).then(function(a){hide("loader");200!=a.status?(failureToast("Printing caches failed with code: "+a.status),a.json().then(function(a){console.error(JSON.stringify(a,null,2))})):successToast("Caches printed")}).catch(function(a){hide("loader");console.error("Unexpected error printing caches: ",a);return!1})}
function loadHardware(){fetch(ROOT_URL+"/hardware").then(function(a){return a.json()}).then(function(a){a.sort(sortJsonByKey("id"));var b="id hardwareName displayName hardwareMake hardwareType multiplier averagePpd".split(" ");for(hardwareDiv=document.getElementById("hardware_div");hardwareDiv.firstChild;)hardwareDiv.removeChild(hardwareDiv.lastChild);hardwareTitle=document.createElement("h2");hardwareTitle.setAttribute("class","navbar-brand");hardwareTitle.innerHTML="Hardware";hardwareDiv.append(hardwareTitle);
hardwareTable=document.createElement("table");hardwareTable.setAttribute("id","hardware");hardwareTable.setAttribute("class","table table-dark table-striped table-hover");hardwareTableHead=document.createElement("thead");hardwareTableHeaderRow=document.createElement("tr");"ID;Name;Display Name;Make;Type;Multiplier;Average PPD".split(";").forEach(function(a,b){hardwareTableHeader=document.createElement("th");hardwareTableHeader.setAttribute("onclick","sortTable("+b+", 'hardware')");hardwareTableHeader.setAttribute("scope",
"col");hardwareTableHeader.innerHTML=a;hardwareTableHeaderRow.append(hardwareTableHeader)});hardwareTableHead.append(hardwareTableHeaderRow);hardwareTable.append(hardwareTableHead);hardwareTableBody=document.createElement("tbody");a.forEach(function(a,c){hardwareTableBodyRow=document.createElement("tr");b.forEach(function(e,b){hardwareTableBodyCell=document.createElement("td");hardwareTableBodyCell.innerHTML="multiplier"===e?"x"+a[e].toLocaleString():"hardwareMake"===e?getHardwareMakeFrontend(a[e]):
"hardwareType"===e?getHardwareTypeFrontend(a[e]):a[e].toLocaleString();hardwareTableBodyRow.append(hardwareTableBodyCell)});hardwareTableBody.append(hardwareTableBodyRow)});hardwareTable.append(hardwareTableBody);hardwareDiv.append(hardwareTable);a.sort(sortJsonByKey("hardwareName"));hardwareLists=document.querySelectorAll(".hardware_list");for(var c=0,d;d=hardwareLists[c];c++){for(;d.firstChild;)d.removeChild(d.lastChild);defaultHardwareOption=document.createElement("option");defaultHardwareOption.setAttribute("value",
"");defaultHardwareOption.setAttribute("disabled","");defaultHardwareOption.setAttribute("selected","");defaultHardwareOption.innerHTML="Choose Hardware...";d.append(defaultHardwareOption);a.forEach(function(a,b){hardwareOption=document.createElement("option");hardwareOption.setAttribute("value",a.id);hardwareOption.setAttribute("hardware_id",a.id);hardwareOption.setAttribute("hardware_name",a.hardwareName);hardwareOption.setAttribute("display_name",a.displayName);hardwareOption.setAttribute("hardware_make",
a.hardwareMake);hardwareOption.setAttribute("hardware_type",a.hardwareType);hardwareOption.setAttribute("multiplier",a.multiplier);hardwareOption.setAttribute("average_ppd",a.averagePpd);hardwareOption.innerHTML=a.hardwareName+" ("+a.displayName+")";d.append(hardwareOption)})}})}
...
function createHardware(){var a=document.getElementById("hardware_create_name").value.trim(),b=document.getElementById("hardware_create_display_name").value.trim(),c=document.getElementById("hardware_create_hardware_make").value.trim(),d=document.getElementById("hardware_create_hardware_type").value.trim(),e=document.getElementById("hardware_create_multiplier").value.trim(),f=document.getElementById("hardware_create_average_ppd").value.trim(),a=JSON.stringify({hardwareName:a,displayName:b,hardwareMake:getHardwareMakeBackend(c),
hardwareType:getHardwareTypeBackend(d),multiplier:e,averagePpd:f});show("loader");fetch(ROOT_URL+"/hardware",{method:"POST",headers:{"Content-Type":"application/json",Authorization:sessionGet("Authorization")},body:a}).then(function(a){hide("loader");201!=a.status?(failureToast("Hardware create failed with code: "+a.status),a.json().then(function(a){console.error(JSON.stringify(a,null,2))})):(document.getElementById("hardware_create_name").value="",document.getElementById("hardware_create_display_name").value=
"",document.getElementById("hardware_create_hardware_make").value="",document.getElementById("hardware_create_hardware_type").value="",document.getElementById("hardware_create_multiplier").value="",document.getElementById("hardware_create_average_ppd").value="",successToast("Hardware '"+b+"' created"),loadHardware())}).catch(function(a){hide("loader");console.error("Unexpected error creating hardware: ",a);return!1})}
function updateHardware(){var a=document.getElementById("hardware_update_selector"),a=document.getElementById("hardware_update_selector");selectedElement=a.options[a.selectedIndex];var a=selectedElement.getAttribute("hardware_id"),b=document.getElementById("hardware_update_name").value.trim(),c=document.getElementById("hardware_update_display_name").value.trim(),d=document.getElementById("hardware_update_hardware_make").value.trim(),e=document.getElementById("hardware_update_hardware_type").value.trim(),
f=document.getElementById("hardware_update_multiplier").value.trim(),g=document.getElementById("hardware_update_average_ppd").value.trim(),b=JSON.stringify({hardwareName:b,displayName:c,hardwareMake:getHardwareMakeBackend(d),hardwareType:getHardwareTypeBackend(e),multiplier:f,averagePpd:g});show("loader");fetch(ROOT_URL+"/hardware/"+a,{method:"PUT",headers:{"Content-Type":"application/json",Authorization:sessionGet("Authorization")},body:b}).then(function(a){hide("loader");if(200!=a.status)failureToast("Hardware update failed with code: "+
a.status),a.json().then(function(a){console.error(JSON.stringify(a,null,2))});else{document.getElementById("hardware_update_id").value="";document.getElementById("hardware_update_name").value="";document.getElementById("hardware_update_display_name").value="";document.getElementById("hardware_update_hardware_make").value="";document.getElementById("hardware_update_hardware_type").value="";document.getElementById("hardware_update_multiplier").value="";document.getElementById("hardware_update_average_ppd").value=
...
a.status),a.json().then(function(a){console.error(JSON.stringify(a,null,2))});else{document.getElementById("hardware_delete_id").value="";document.getElementById("hardware_delete_name").value="";document.getElementById("hardware_delete_display_name").value="";document.getElementById("hardware_delete_hardware_make").value="";document.getElementById("hardware_delete_hardware_type").value="";document.getElementById("hardware_delete_multiplier").value="";document.getElementById("hardware_delete_average_ppd").value=
"";hardwareFields=document.querySelectorAll(".hardware_delete");a=0;for(var c;c=hardwareFields[a];a++)hideElement(c);successToast("Hardware '"+b+"' deleted");loadHardware()}}).catch(function(a){hide("loader");console.error("Unexpected error deleting hardware: ",a);return!1})}
...
function populateHardwareUpdate(){show("loader");element=document.getElementById("hardware_update_selector");selectedElement=element.options[element.selectedIndex];document.getElementById("hardware_update_id").value=selectedElement.getAttribute("hardware_id");document.getElementById("hardware_update_name").value=selectedElement.getAttribute("hardware_name");document.getElementById("hardware_update_display_name").value=selectedElement.getAttribute("display_name");document.getElementById("hardware_update_hardware_make").value=
selectedElement.getAttribute("hardware_make");document.getElementById("hardware_update_hardware_type").value=selectedElement.getAttribute("hardware_type");document.getElementById("hardware_update_multiplier").value=selectedElement.getAttribute("multiplier");document.getElementById("hardware_update_average_ppd").value=selectedElement.getAttribute("average_ppd");hardwareFields=document.querySelectorAll(".hardware_update");for(var a=0,b;b=hardwareFields[a];a++)showElement(b);hide("loader")}
function populateHardwareDelete(){show("loader");element=document.getElementById("hardware_delete_selector");selectedElement=element.options[element.selectedIndex];document.getElementById("hardware_delete_id").value=selectedElement.getAttribute("hardware_id");document.getElementById("hardware_delete_name").value=selectedElement.getAttribute("hardware_name");document.getElementById("hardware_delete_display_name").value=selectedElement.getAttribute("display_name");document.getElementById("hardware_delete_hardware_make").value=
selectedElement.getAttribute("hardware_make");document.getElementById("hardware_delete_hardware_type").value=selectedElement.getAttribute("hardware_type");document.getElementById("hardware_delete_multiplier").value=selectedElement.getAttribute("multiplier");document.getElementById("hardware_delete_average_ppd").value=selectedElement.getAttribute("average_ppd");hardwareFields=document.querySelectorAll(".hardware_delete");for(var a=0,b;b=hardwareFields[a];a++)showElement(b);hide("loader")}
...
selectedElement.getAttribute("user_category");document.getElementById("user_offset_hardware_selector").value=selectedElement.getAttribute("user_hardware_id");document.getElementById("user_offset_team_selector").value=selectedElement.getAttribute("user_team_id");fetch(ROOT_URL+"/stats/users/"+userId).then(function(a){return a.json()}).then(function(a){document.getElementById("user_offset_points").value=a.multipliedPoints;document.getElementById("user_offset_units").value=a.units});userFields=document.querySelectorAll(".user_offset");
for(var a=0,b;b=userFields[a];a++)showElement(b);hide("loader")}function show(a){document.getElementById(a).style.display="block"}function showElement(a){a.style.display="block"}function hide(a){document.getElementById(a).style.display="none"}function hideElement(a){a.style.display="none"}function encode(a,b){return btoa(a+":"+b)}function getCategoryFrontend(a){return"amd_gpu"===a.toLowerCase()?"AMD GPU":"nvidia_gpu"===a.toLowerCase()?"nVidia GPU":"wildcard"===a.toLowerCase()?"Wildcard":a}
function getCategoryBackend(a){return"amd gpu"===a.toLowerCase()?"amd_gpu":"nvidia gpu"===a.toLowerCase()?"nvidia_gpu":"wildcard"===a.toLowerCase()?"wildcard":a}function getHardwareMakeFrontend(a){return"amd"===a.toLowerCase()?"AMD":"nvidia"===a.toLowerCase()?"nVidia":"intel"===a.toLowerCase()?"Intel":a}function getHardwareMakeBackend(a){return"amd gpu"===a.toLowerCase()?"AMD":"nvidia"===a.toLowerCase()?"NVIDIA":"intel"===a.toLowerCase()?"INTEL":a}
function getHardwareTypeFrontend(a){return"gpu"===a.toLowerCase()?"GPU":"cpu"===a.toLowerCase()?"CPU":a}function getHardwareTypeBackend(a){return"gpu"===a.toLowerCase()?"GPU":"cpu"===a.toLowerCase()?"CPU":a}function sortJsonByKey(a){return function(b,c){return b[a]>c[a]?1:b[a]<c[a]?-1:0}}function localGet(a){return localStorage.getItem(a)}function localSet(a,b){localStorage.setItem(a,b)}function localContains(a){return null!==localGet(a)}function sessionGet(a){return sessionStorage.getItem(a)}
function sessionSet(a,b){sessionStorage.setItem(a,b)}function sessionContains(a){return null!==sessionGet(a)}
