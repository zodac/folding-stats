...
usersTableHead.append(usersTableHeaderRow);usersTable.append(usersTableHead);usersTableBody=document.createElement("tbody");a.forEach(function(a,d){usersTableBodyRow=document.createElement("tr");b.forEach(function(b,c){usersTableBodyCell=document.createElement("td");"liveStatsLink"===b?b in a&&(liveStatsLink=document.createElement("a"),liveStatsLink.setAttribute("href",a[b]),liveStatsLink.innerHTML=a[b],usersTableBodyCell.append(liveStatsLink)):b in a&&(usersTableBodyCell.innerHTML=a[b].toLocaleString());
usersTableBodyRow.append(usersTableBodyCell)});usersTableBody.append(usersTableBodyRow)});usersTable.append(usersTableBody);usersDiv.append(usersTable)})}
...
teamsTable.append(teamsTableHead);teamsTableBody=document.createElement("tbody");a.forEach(function(a,d){teamsTableBodyRow=document.createElement("tr");b.forEach(function(b,c){teamsTableBodyCell=document.createElement("td");"liveStatsLink"===b?b in a&&(liveStatsLink=document.createElement("a"),liveStatsLink.setAttribute("href",a[b]),liveStatsLink.innerHTML=a[b],teamsTableBodyCell.append(liveStatsLink)):b in a&&(teamsTableBodyCell.innerHTML=a[b].toLocaleString());teamsTableBodyRow.append(teamsTableBodyCell)});
teamsTableBody.append(teamsTableBodyRow)});teamsTable.append(teamsTableBody);teamsDiv.append(teamsTable)})}document.addEventListener("DOMContentLoaded",function(a){loadHardware();loadUsers();loadTeams();updateTimer()});function sortJsonByKey(a){return function(b,c){return b[a]>c[a]?1:b[a]<c[a]?-1:0}}
