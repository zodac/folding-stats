...
function manualUpdate(){show("loader");fetch(ROOT_URL+"/stats/manual/update",{headers:{"Content-Type":"application/json",Authorization:sessionGet("Authorization")},body:requestData}).then(function(a){hide("loader");200!=a.status?(failureToast("Manual update failed with code: "+a.status),a.json().then(function(a){console.error(JSON.stringify(a,null,2))})):successToast("Stats manually updated")}).catch(function(a){console.error("Unexpected error updating stats: ",a);return!1})}
function manualReset(){show("loader");fetch(ROOT_URL+"/stats/manual/reset",{headers:{"Content-Type":"application/json",Authorization:sessionGet("Authorization")},body:requestData}).then(function(a){hide("loader");200!=a.status?(failureToast("Manual reset failed with code: "+a.status),a.json().then(function(a){console.error(JSON.stringify(a,null,2))})):successToast("Stats manually reset")}).catch(function(a){console.error("Unexpected error resetting stats: ",a);return!1})}
...
successToast("User '"+c+"' stats updated: "+h+" points, "+k+" units"),loadUsers())}).catch(function(a){console.error("Unexpected error offsetting user stats: ",a);return!1})})}
