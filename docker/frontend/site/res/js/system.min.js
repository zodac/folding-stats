...
function getHardwareMakeFrontend(a){return"amd"===a.toLowerCase()?"AMD":"nvidia"===a.toLowerCase()?"nVidia":"intel"===a.toLowerCase()?"Intel":a}function getHardwareMakeBackend(a){return"amd gpu"===a.toLowerCase()?"AMD":"nvidia"===a.toLowerCase()?"NVIDIA":"intel"===a.toLowerCase()?"INTEL":a}function getHardwareTypeFrontend(a){return"gpu"===a.toLowerCase()?"GPU":"cpu"===a.toLowerCase()?"CPU":a}function getHardwareTypeBackend(a){return"gpu"===a.toLowerCase()?"GPU":"cpu"===a.toLowerCase()?"CPU":a}
