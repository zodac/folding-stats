...
a.forEach(function(a,b){hardwareOption=document.createElement("option");hardwareOption.setAttribute("value",a.id);hardwareOption.setAttribute("hardware_id",a.id);hardwareOption.setAttribute("hardware_name",a.hardwareName);hardwareOption.setAttribute("display_name",a.displayName);hardwareOption.setAttribute("multiplier",a.multiplier);hardwareOption.innerHTML=a.hardware_name;d.append(hardwareOption)})}})}
