...
!0;break}}else if(parseInt(f.innerHTML)<parseInt(g.innerHTML)){h=!0;break}h?(b[d].parentNode.insertBefore(b[d+1],b[d]),e=!0,l++):0==l&&"asc"==k&&(k="desc",e=!0)}}function updateTimer(){var a=new Date,a=3600-(a.getUTCMinutes()-55)%60*60-a.getUTCSeconds();minutes=Math.floor(a/60)%60;seconds=a%60;document.getElementById("min-part").innerHTML=minutes;document.getElementById("sec-part").innerHTML=String(seconds).padStart(2,"0");setTimeout(updateTimer,1E3-(new Date).getUTCMilliseconds())};