...
document.addEventListener("DOMContentLoaded",function(a){populateTeamDropdown("team_dropdown");populateDayDropdown(selectedMonth,selectedYear,"day_dropdown","getTeamHistoricStats");populateMonthDropdown("month_dropdown","getTeamHistoricStats");populateYearDropdown("year_dropdown","getTeamHistoricStats");updateTimer()});function show(a){document.getElementById(a).style.display="block"}function hide(a){document.getElementById(a).style.display="none"}
var NUMBER_OF_MONTHS=12,NUMBER_OF_YEARS_TO_SHOW=2,YEAR_START=(new Date).getUTCFullYear();
