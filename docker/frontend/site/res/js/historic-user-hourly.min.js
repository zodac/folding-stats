...
document.addEventListener("DOMContentLoaded",function(a){populateUserDropdown("user_dropdown");populateDayDropdown(selectedMonth,selectedYear,"day_dropdown","getUserHistoricStats");populateMonthDropdown("month_dropdown","getUserHistoricStats");populateYearDropdown("year_dropdown","getUserHistoricStats");updateTimer()});function show(a){document.getElementById(a).style.display="block"}function hide(a){document.getElementById(a).style.display="none"}
