...
"col");teamTableHeaderCell.innerHTML=a;teamTableHeaderRow.append(teamTableHeaderCell)});teamTableHead.append(teamTableHeaderRow);teamTable.append(teamTableHead);teamTableBody=document.createElement("tbody");activeUsers=a.activeUsers;activeUsers.sort(sortJsonByKey("rankInTeam"));activeUsers.forEach(function(a,c){teamTableBodyRow=document.createElement("tr");b.forEach(function(b,c){teamTableUserCell=document.createElement("td");"multipliedPoints"===b?(teamTableUserCell.setAttribute("data-bs-toggle",
"tooltip"),teamTableUserCell.setAttribute("data-placement","left"),teamTableUserCell.setAttribute("title","Unmultiplied: "+a.points.toLocaleString()),teamTableUserCell.innerHTML=a[b].toLocaleString(),new bootstrap.Tooltip(teamTableUserCell)):"userName"===b&&a[b]===d?teamTableUserCell.innerHTML=a[b].toLocaleString()+" (Captain)":"hardware"===b?(teamTableUserCell.setAttribute("data-bs-toggle","tooltip"),teamTableUserCell.setAttribute("data-placement","left"),teamTableUserCell.setAttribute("title","Multiplier: x"+
a.hardware.multiplier.toLocaleString()),teamTableUserCell.innerHTML=a[b].displayName.toLocaleString(),new bootstrap.Tooltip(teamTableUserCell)):teamTableUserCell.innerHTML=a[b].toLocaleString();teamTableBodyRow.append(teamTableUserCell)});teamTableBody.append(teamTableBodyRow)});retiredUsers=a.retiredUsers;retiredUsers.sort(sortJsonByKey("rankInTeam"));retiredUsers.forEach(function(a,c){teamTableBodyRow=document.createElement("tr");b.forEach(function(b,c){teamTableUserCell=document.createElement("td");
"multipliedPoints"===b?(teamTableUserCell.setAttribute("data-bs-toggle","tooltip"),teamTableUserCell.setAttribute("data-placement","left"),teamTableUserCell.setAttribute("title","Unmultiplied: "+a.points.toLocaleString()),teamTableUserCell.innerHTML=a[b].toLocaleString(),new bootstrap.Tooltip(teamTableUserCell)):"userName"===b?teamTableUserCell.innerHTML=a[b]+" (retired)":"hardware"===b?(teamTableUserCell.setAttribute("data-bs-toggle","tooltip"),teamTableUserCell.setAttribute("data-placement","left"),
teamTableUserCell.setAttribute("title","Multiplier: x"+a.hardware.multiplier.toLocaleString()),teamTableUserCell.innerHTML=a[b].displayName.toLocaleString(),new bootstrap.Tooltip(teamTableUserCell)):teamTableUserCell.innerHTML=a[b].toLocaleString();teamTableBodyRow.append(teamTableUserRow)});teamTableBody.append(teamTableBodyRow)});teamTable.append(teamTableBody);subDiv.append(teamTable);teamDiv.append(subDiv);statsDiv.append(teamDiv);statsDiv.append(document.createElement("br"))});hide("loader")})}
document.addEventListener("DOMContentLoaded",function(a){loadTcStats();updateTimer()});function show(a){document.getElementById(a).style.display="block"}function hide(a){document.getElementById(a).style.display="none"}window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag("js",new Date);gtag("config","G-NTH3EFBH2T");function sortJsonByKey(a){return function(e,b){return e[a]>b[a]?1:e[a]<b[a]?-1:0}}
