...
function loadCategoryLeaderboard(){fetch(ROOT_URL+"/stats/category").then(function(a){return a.json()}).then(function(a){categoryDiv=document.getElementById("category_div");var b="Rank;User;Points;Hardware;Units;Points to Leader;Points to Next".split(";"),c="rank displayName hardware multipliedPoints units diffToLeader diffToNext".split(" ");categoryLeaderboardTitle=document.createElement("h2");categoryLeaderboardTitle.setAttribute("class","navbar-brand");categoryLeaderboardTitle.innerHTML="Category Leaderboard";
