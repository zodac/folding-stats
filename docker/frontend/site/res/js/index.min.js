...
"left"),teamTableUserCell.setAttribute("title","Unmultiplied: "+a.points.toLocaleString()),teamTableUserCell.innerHTML=a[b].toLocaleString(),new bootstrap.Tooltip(teamTableUserCell)):"userName"===b&&a[b]===f?teamTableUserCell.innerHTML=a[b].toLocaleString()+" (Captain)":"hardware"===b?(teamTableUserCell.setAttribute("data-bs-toggle","tooltip"),teamTableUserCell.setAttribute("data-placement","left"),teamTableUserCell.setAttribute("title","Multiplier: x"+a.hardware.multiplier.toLocaleString()),teamTableUserCell.innerHTML=
