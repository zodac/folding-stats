...
function getCategoryFrontend(a){return"amd_gpu"===a.toLowerCase()?"AMD GPU":"nvidia_gpu"===a.toLowerCase()?"nVidia GPU":"wildcard"===a.toLowerCase()?"Wildcard":a}function getCategoryBackend(a){return"amd gpu"===a.toLowerCase()?"amd_gpu":"nvidia gpu"===a.toLowerCase()?"nvidia_gpu":"wildcard"===a.toLowerCase()?"wildcard":a}function getHardwareMakeFrontend(a){return"amd"===a.toLowerCase()?"AMD":"nvidia"===a.toLowerCase()?"nVidia":"intel"===a.toLowerCase()?"Intel":a}
function getHardwareMakeBackend(a){return"amd gpu"===a.toLowerCase()?"AMD":"nvidia"===a.toLowerCase()?"NVIDIA":"intel"===a.toLowerCase()?"INTEL":a}function getHardwareTypeFrontend(a){return"gpu"===a.toLowerCase()?"GPU":"cpu"===a.toLowerCase()?"CPU":a}function getHardwareTypeBackend(a){return"gpu"===a.toLowerCase()?"GPU":"cpu"===a.toLowerCase()?"CPU":a}var NUMBER_OF_UPDATES_PROPERTY_NAME="numberOfUpdates",UPDATE_MINUTE=55;function startTimer(){calculateNumberOfUpdates();updateTimer()}
